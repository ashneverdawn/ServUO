        ...
        public override void OnCast()
        {
                ...
                */
                if (this.CheckSequence())
                {
                    ...
                    if (mods == null)
                    {
                        ...
                        int physiMod = -25 + (int)(targ.Skills[SkillName.Inscribe].Base / 20);
                        int otherMod = 10;
            ...
            else
            {
                ...
                else if (this.CheckSequence())
                {
                    ...
                    {
                        int value = (int)(this.Caster.Skills[SkillName.Magery].Value + this.Caster.Skills[SkillName.Inscribe].Base);
